...
import { UserTypeOrmRepository } from '../src/auth/repositories/user/UserTypeOrmRepository';
import { User } from '../src/libs/db/entity/User';
...
describe('Auth Registration (e2e)', () => {
    ...
    describe('POST /auth/registration', () => {
        it('should return 400 for invalid login', () => {
